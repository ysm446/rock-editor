...
inline bool CompilePresetMaterials(const LayerMaterial& material, std::vector<PresetMaterial>& layers, std::string& error) {
    return CompilePresetMaterials(MaterialPreviewPreset(material), layers, error);
}
