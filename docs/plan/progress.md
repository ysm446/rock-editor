...
更新日時: 2026-09-21 01:45

## 現在地

ユーザー指定の **`Random Boxes → To Volume → Volume to Mesh → Mesh Output`** を追加した。重なる直方体の塊を Seed で作り、実体のある3次元グリッドへ変換して外皮を表示できる。まず単純な塊づくりから進める。
...
| 次の作業 | Random Boxes と To Volume の塊を試し、必要な形の調整を判断する |
