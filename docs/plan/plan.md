...
P5 の母岩4形状と弱い BaseNoise を実装した（P5 前半）。曲面の生成・平面分割と seed の再現性を検証済み。次は P5 後半の Joint Set と複数節理。外観は [参考写真との対応](../reference/visual-target.md) で比較する。

1. Joint Set の方向・間隔・ばらつき・本数・seed を定義し、パッチ列の生成とプレビュー・保存を追加する。
